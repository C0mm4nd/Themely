...
std::map<std::string, std::wstring> ENGLISH = {
	...
	{"dump_prompt_warn",    L"Please don't submit official themes!"},
	{"playing",             L"Playing..."},
	{"no_themes_1",         L"No themes found!"},
	{"no_themes_2",         L"Go to 3dsthemesarchive.tk on your computer, download some themes,"},
	...
	{"qr_explain_6",        L"click on the big green button that says qr code than scan it."},
